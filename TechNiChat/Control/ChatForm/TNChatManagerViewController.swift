...
extension TNChatManagerViewController{
    ...
    func uiCreateChat(){
        btnCreateChat = UIButton(background: .orange, height: 48, ratioHW: 1, corner: 24, border: 0, borderColor: nil, design: nil)
        ...
        btnCreateChat.setImage(UIImage(named: "ic_edit")?.withRenderingMode(.alwaysTemplate), for: .normal)
