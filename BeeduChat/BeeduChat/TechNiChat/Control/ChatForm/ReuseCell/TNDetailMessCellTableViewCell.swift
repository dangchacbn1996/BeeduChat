...
struct TNDetailMessModel {
    var avartar : UIImage? = nil
    var user : String = ""
}

class TNDetailMessCellTableViewCell: UITableViewCell {

    static let identify = "TNDetailMessCellTableViewCell"
    ...
    var data : TNDetailMessModel = TNDetailMessModel(){
        didSet{
...
extension TNDetailMessCellTableViewCell {
    func setupUI(){
