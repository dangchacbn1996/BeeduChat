...
struct TNCreateGroupCellModel {
    var avatar : UIImage? = nil
    var name : String = ""
    var content : String = ""
}

class TNCreateGroupCell: UITableViewCell {
    static let identify = "TNCreateGroupCell"
    ...
    var data : TNCreateGroupCellModel = TNCreateGroupCellModel(){
        didSet{
