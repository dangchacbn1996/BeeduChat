...
class CreateGroupViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tbvContentView.register(CreateGroupCell.self, forCellReuseIdentifier: CreateGroupCell.identify)
...
extension CreateGroupViewController : UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: CreateGroupCell.identify, for: indexPath) as! CreateGroupCell
        cell.selectionStyle = .none
        if (indexPath.row % 2 == 0) {
            cell.data = CreateGroupCellModel(avatar: UIImage(named: "ic_ava"), name: "Bố Tú Anh", content: "Phụ huynh")
        }
        else{
            cell.data = CreateGroupCellModel(avatar:UIImage(named: "ic_ava"), name: "Bố Tú Anh", content: "Phụ huynh")
        }
